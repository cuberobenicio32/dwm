...
/* tagging */
static const char *tags[] = { "term", "www", "dev", "doc", "media", "sys", "chat",}; 
...
static Key keys[] = {
	...
	/* My custom keys */
	{ MODKEY,			XK_w,	   spawn,	   SHCMD("chromium") }, /* I don't use $BROWSER here because for some reason it doesn't work*/
	...
	{ MODKEY|ShiftMask, 		XK_m,      spawn,	   SHCMD(TERMINAL "ncmpcpp") },	 
	{ MODKEY|ShiftMask, 		XK_p,      spawn,	   SHCMD("polychromatic-controller") },	 
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
